...
publishable_key = 'pk_test_51L1nfUJoLI4CMz0hasviZzOL4c6CbFu7rZFQvezZUue6yRUscy2ZN8lDXUaf215tlKJwkUTwaKHyONQrqq2JMFLr00vm4UGtU3' #'pk_test_MaILxTYQ15v5Uhd6NKI9wPdD00qdL0QZSl'
stripe.api_key = 'sk_test_51L1nfUJoLI4CMz0hT1V0Dv9TiBAByUAdJg7zdiIo0E7L9M2wRyBcLQRE9acfudyYdh0CCeHuygntFwdEVexExgsG00GQrt8Lmx' #'sk_test_9JlhVB6qwjcRdYzizjdwgIo0Dt00N55uxbWy'
...
def payment():
    ...
    #orders.status = 'Paid'
    #db.session.commit()
    return render_template('customer/thank.html') #redirect(url_for('thanks'))
